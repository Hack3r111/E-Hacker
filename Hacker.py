...
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mEHacker.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
...
\033[1;91m☞ Auther     : Muntazir-Abbas
\033[1;92m☞ WhatsApp   : 03554591856
\033[1;95m☞ Facebook    : https://www.facebook.com/Itx.ZaiN.2023
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update E-Hacker Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' E-Hacker WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 03554591856✓')
	    psb('WellCome To E-Hacker✓™')
	    psb('Congratulations E-Hacker✓™ Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Muntazir✓')
	    psb('🔓Password ☆ 2081563✓')
	    psb('Follow  Me on Facebook  iññocent  MusAfir✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/E-Hacker && python2 B4.py')
	elif bm =='3':
